                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('user_type_id') ? ' has-error' : '' }}">
                            <label for="user_type_id" class="col-md-4 control-label">Type utilisateur</label>

                            <div class="col-md-6">
                                <input id="user_type_id" type="text" class="form-control" name="user_type_id" value="2" required autofocus>
